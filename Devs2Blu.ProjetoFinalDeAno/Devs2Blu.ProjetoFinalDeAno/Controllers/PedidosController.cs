...
namespace Devs2Blu.ProjetoFinalDeAno.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public PedidosController(ContextoDatabase context)
        {
            _context = context;
        }
        ...
        {
            var contextoDatabase = _context.Pedido.Include(p => p.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCliente,Created_time,Status")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdCliente,Created_time,Status")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContextoDatabase.Pedido'  is null.");
            }
            var pedido = await _context.Pedido.FindAsync(id);
            if (pedido != null)
            {
